...
<?php
require_once ("consultas/sqlhabitacion.php");
?>
    ...
    <div class="page">
      ...
      <section class="">
        <div class="breadcrumbs-custom context-dark bg-overlay-46">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Elija la habitación que quiera del hotel La Posada</h2>
            <ul class="breadcrumbs-custom-path">
              <li><a href="index.php">Inicio</a></li>
              <li><a href="servicios.php">Servicios</a></li>
              <li><a href="habitacion.php">Habitaciones</a></li>
        ...
        <div class="container">
          <div class="row-sm row-40 row-md-50 justify-content-center">
            <div class="col-sm-12 col-md-12 wow fadeInRight">
              ...
              <article class="product-big">
                <div class="unit flex-column flex-md-row align-items-md-stretch">
                  <div class="unit-left"><a class="product-big-figure" href="**.html"><img src="img/Reserva/CA01.jpg" alt="" width="600" height="366"/></a></div>
                  <div class="unit-body">
                    <div class="product-big-body">
                      <h5 class="product-big-title"><a href="**.html">HABITACIÓN SIMPLE </a></h5>
                      ...
                      <p class="product-big-text">Habitación con una cama para uso de maximo 2 personas</p><a class="button button-black-outline button-ujarak" href="pago.php">Buy This Tour</a>
                      <div class="product-big-price-wrap"><?php echo'<span class="product-big-price">S/' . $preciosimple['price_day'] . '</span>';?> </div> 
                    </div>
                  </div>
                </div>
              </article>
            ...
            <div class="col-sm-12 col-md-12 wow fadeInLeft">
              ...
              <article class="product-big">
                <div class="unit flex-column flex-md-row align-items-md-stretch">
                  <div class="unit-left"><a class="product-big-figure" href="**.html"><img src="img/Reserva/CA03.jpg" alt="" width="600" height="366"/></a></div>
                  <div class="unit-body">
                    <div class="product-big-body">
                      <h5 class="product-big-title"><a href="**.html">HABITACIÓN DOBLE</a></h5>
                      <div class="group-sm group-middle justify-content-start">
                        <div class="product-big-rating"><span class="icon material-icons-star"></span><span class="icon material-icons-star"></span><span class="icon material-icons-star"></span><span class="icon material-icons-star"></span><span class="icon material-icons-star_half"></span></div><a class="product-big-reviews" href="#"></a>
                      </div>
                      <p class="product-big-text">Habitación con dos camas separadas para maximo 4 personas</p><a class="button button-black-outline button-ujarak" href="pago.php">Buy This Tour</a>
                      <div class="product-big-price-wrap"><?php echo'<span class="product-big-price">S/' . $preciodoble['price_day'] . '</span>';?> </div>
                    </div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-12 col-md-12 wow fadeInLeft"></div>
            <!-- Product Big-->
            <article class="product-big">
              <div class="unit flex-column flex-md-row align-items-md-stretch">
                <div class="unit-left"><a class="product-big-figure" href="**.html"><img src="img/Reserva/CA04.jpg" alt="" width="600" height="366"/></a></div>
                <div class="unit-body">
                  <div class="product-big-body">
                    <h5 class="product-big-title"><a href="**.html">HABITACIÓN TRIPLE</a></h5>
                    <div class="group-sm group-middle justify-content-start">
                      <div class="product-big-rating"><span class="icon material-icons-star"></span><span class="icon material-icons-star"></span><span class="icon material-icons-star"></span><span class="icon material-icons-star"></span><span class="icon material-icons-star_half"></span></div><a class="product-big-reviews" href="#"></a>
                    </div>
                    <p class="product-big-text">Amplia habitación con 3 camas individuales para maximo 6 personas</p><a class="button button-black-outline button-ujarak" href="pago.php">Buy This Tour</a>
                    <div class="product-big-price-wrap"><?php echo'<span class="product-big-price">S/' . $preciotriple['price_day'] . '</span>';?> </div>
                  </div>
                </div>
              </div>
            </article>
