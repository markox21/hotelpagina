...
<meta name="description" content="Bienvenido al Hotel en Chancay, donde ofrecemos alojamiento de calidad, servicios excepcionales y una estancia confortable. Disfruta de nuestras habitaciones con vistas al mar, realiza reservas para tu viaje a Chancay y experimenta el mejor turismo en la zona. ¡Te esperamos para brindarte un descanso inolvidable!" />
    <script src="/cdn-cgi/apps/head/3ts2ksMwXvKRuG480KNifJ2_JNM.js"></script><link rel="icon" href="img/favicon.ico" type="image/x-icon">
    <!-- Stylesheets-->
  ...
  <body>
    ...
    <div class="page">
          ...
          <section class="">
            <div class="breadcrumbs-custom context-dark bg-overlay-60">
              <div class="container">
                <h2 class="breadcrumbs-custom-title">Promociones</h2>
                <ul class="breadcrumbs-custom-path">
                  <li><a href="index.php">Inicio</a></li>
                  <li class="active">Promociones</li>
                </ul>
              </div>
              <div class="box-position" style="background-image: url(img/Nosotros/PT01.jpg);"></div>
            </div>
          </section>
          <!--Fin-->
    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fprofile.php%3Fid%3D61552875982829%26locale%3Des_LA&tabs=timeline&width=800&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="500" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
            <iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fprofile.php%3Fid%3D61552875982829&width=400&layout=button_count&action=like&size=large&share=true&height=35&appId=1408497620079146" width="400" height="35" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
        </div>
        <div class="col-md-6 mx-auto">
            <!-- Agregar imagen encima del iframe -->
            <iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fphoto%3Ffbid%3D122094198254095866%26set%3Da.122094194330095866&width=552&show_text=true&appId=1408497620079146&height=534" width="552" height="534" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
        </div>
    </div>
</div>
