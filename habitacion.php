    ...
    <div class="page">
      ...
      <body class="stretched">
	    <div id="wrapper" class="clearfix">
		              ...
		              <!-- Header-->
		              <?php include('in/header.php');?><!--Fin Header-->
                   <!-- Preloader-->
		              <div id="preloader">
			              <div id="status">
  ...
  <div class="conteiner-grid">
          <section class="">
            <div class="breadcrumbs-custom context-dark bg-overlay-46">
              <div class="container">
                <h2 class="breadcrumbs-custom-title">Habitaciones</h2>
              ...
              <div class="box-position" style="background-image: url(img/Habitaciones/PT01.jpg);"></div>
            </div>
          </section>
          <!--Imagenes de las 3 columnas-->
          <!-- Section Box Categories-->
          <section class="section section-lg section-top bg-gray-4">
                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                      <ul class="list-marked-2 box-categories-list">
                        <li><a href=""><img src="img/Habitaciones/H01.jpg" alt="" class=".img.habitacion"/></a>
                          <h5 class="box-categories-title">HABITACION DOBLE</h5>
                        </li>
                      </ul>
                    </div>
                    <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                      <ul class="list-marked-2 box-categories-list">
                        <li><a href=""><img src="img/Habitaciones/H02.jpg" alt="" class=".img.habitacion"></a>
                          <h5 class="box-categories-title">HABITACION TRIPLE</h5>
                        </li>
                      </ul>
                    </div>
                    <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                      <ul class="list-marked-2 box-categories-list">
                        <li><a href=""><img src="img/Habitaciones/H03.jpg" alt="" class=".img.habitacion"/></a>
                          <h5 class="box-categories-title">HABITACION SIMPLE</h5>
                        </li>
                      </ul>
                    </div>
                  </div>
                </div>
                <!--/div><a class="link-classic wow fadeInUp" href="">Mas Habitaciones<span></span></a-->
            </div>
          </section>
        ...
        <section class="section section-sm section-first bg-default text-md-left">
          ...
          <div class="container">
            <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
              <div class="col-lg-6 text-center wow fadeInUp"><img src="img/Habitaciones/PT01.jpg" alt="" width="556" height="382"/>
              </div>
                  ...
                  <div class="tabs-custom tabs-horizontal tabs-line tabs-line-big tabs-line-style-2 text-center text-md-left" id="tabs-7">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade show active" id="tabs-7-1">
                        ...
                        <div class="group-md group-middle"><a class="button button-secondary button-pipaluk" href="reserva.php">QUE ESPERAS RESERVA YA!</a>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section>
          ...
          <section class="section section-sm section-fluid bg-default">
            <div class="container">
              <h3>IMAGENES DE NUESTRO HABITACIONES</h3>
            </div>
            <!-- Owl Carousel-->
            <div class="owl-carousel owl-classic owl-timeline" data-items="1" data-md-items="2" data-lg-items="3" data-xl-items="4" data-margin="30" data-autoplay="false" data-nav="true" data-dots="true">
              <div class="owl-item">
                ...
                <article class="thumbnail thumbnail-mary">
                  <div class="thumbnail-mary-figure"><img src="img/Habitaciones/HL01.jpg" alt="" width="420" height="308"/>
                  </div>
                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="img/Habitaciones/HL01.jpg" data-lightgallery="item"><img src="img/Habitaciones/HL01.jpg" alt="" width="420" height="308"/></a>
                  </div>
                </article>
              ...
              <div class="owl-item">
                <!-- Thumbnail Classic-->
                <article class="thumbnail thumbnail-mary">
                  <div class="thumbnail-mary-figure"><img src="img/Habitaciones/HL02.jpg" alt="" width="420" height="308"/>
                  </div>
                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="img/Habitaciones/HL02.jpg" data-lightgallery="item"><img src="img/Habitaciones/HL02.jpg" alt="" width="420" height="308"/></a>
                  </div>
                </article>
                <!--div class="thumbnail-mary-description">
              ...
              <div class="owl-item">
                <!-- Thumbnail Classic-->
                <article class="thumbnail thumbnail-mary">
                  <div class="thumbnail-mary-figure"><img src="img/Habitaciones/HL03.jpg" alt="" width="420" height="308"/>
                  </div>
                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="img/Habitaciones/HL03.jpg" data-lightgallery="item"><img src="img/Habitaciones/HL03.jpg" alt="" width="420" height="308"/></a>
                  </div>
                </article>
                <!--div class="thumbnail-mary-description">
              ...
              <div class="owl-item">
                <!-- Thumbnail Classic-->
                <article class="thumbnail thumbnail-mary">
                  <div class="thumbnail-mary-figure"><img src="img/Habitaciones/HL04.jpg" alt="" width="420" height="308"/>
                  </div>
                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="img/Habitaciones/HL04.jpg" data-lightgallery="item"><img src="img/Habitaciones/HL04.jpg" alt="" width="420" height="308"/></a>
                  </div>
                </article>
                <!--div class="thumbnail-mary-description">
          ...
          <div class="container">
            <div class="row justfy-content-xl-space-berween row-10 align-items-md-center2">
              ...
              <div class="col-sm-6 col-md-4 order-sm-first">
                <!-- Rights-->
                <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span> <span>Wonder Tour</span>. All rights reserved<span>.</span>
                </p>
              </div>
