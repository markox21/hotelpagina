...
<meta name="description" content="Bienvenido al Hotel en Chancay, donde ofrecemos alojamiento de calidad, servicios excepcionales y una estancia confortable. Disfruta de nuestras habitaciones con vistas al mar, realiza reservas para tu viaje a Chancay y experimenta el mejor turismo en la zona. ¡Te esperamos para brindarte un descanso inolvidable!" />
  ...
  <div class="conteiner-grid">
      ...
      <a href="https://www.tiktok.com/@laposadahospedaje" class="text-center tiktok-color tiktok-background"><i class="fab fa-tiktok"></i></a>
          ...
          <section class="section section-sm section-first bg-default text-md-left">
            <div class="container">
              <div class="row row-50 justify-content-center align-items-xl-center">
                <div class="col-md-10 col-lg-5 col-xl-6"><img src="img/Nosotros/CH01.jpg" alt="" width="519" height="564"/>
                </div>
                <div class="col-md-10 col-lg-7 col-xl-6">
                  <h3 class="text-spacing-25 font-weight-normal title-opacity-9">Quiénes somos</h3>
                  <div>
                  </div>
                  <p>Somos una empresa familiar preocupado en bridar mucha hospitalidad a nuestros huespedes y hacerlos sentir en familia. Usted es muy importante para nosotros Reserve y sienta la diferencia!</p>
                </div>
              </div>
            </div>
          ...
          <div class="container offset-negative-1 mt-5">
            <h3 class="text-center text-size">Estamos a 2 cuadras de la plaza de armas de Chancay</h3>
            <div></div>
           ...
           <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
            ...
            <!-- Carrusel 1 -->
            <div class="col-lg-6 wow text-center fadeInUp">
            <div id="carousel1" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="img/Nosotros/CL01.1.jpg" alt="Castillo de Chancay" width="556" height="382" />
                </div>
              </div>
            </div>
            <p class="text-center">CHANCAY</p>
            </div>
          ...
          <!-- Carrusel 2 -->
            ...
            <div id="carousel2" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="img/Nosotros/CL02.1.jpg" alt="Eco Truly Park" width="556" height="382" />
                </div>
              </div>
            </div>
            <p class="text-center">LA GLORIETA</p>
            </div>
            </div>
          </section>
          </div>
